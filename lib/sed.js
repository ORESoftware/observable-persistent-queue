...
module.exports = function (queue, pattern, isReplace, $count, choice) {
    ...
    return Rx.Observable.create(obs => {
        ...
        const data = rpl.hello(file, '\\S+', isReplace, count, priority, prioritySearchCap);
...
function old(queue, pattern, count, choice) {
