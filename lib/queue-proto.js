...
var QProto = (function () {
    ...
    QProto.prototype._enqControlled = function (lines, opts) {
        ...
        var $add = this.init()
            .flatMap(function () {
            return waitForClientCount(_this, { timeout: 3000, count: 5, index: null });
        })
            .flatMap(function () {
        ...
        var $dequeue = obs
            ...
            if (diff < 1) {
                ...
                return releaseLock(_this, obj.id)
                    ...
                    return rxjs_1.Observable.race(rxjs_1.Observable.timer(8500), _this.obsEnqueue.skip(diff).take(1));
                })
                    .filter(function () {
                    obs.next();
                    return false;
