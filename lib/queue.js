...
const { countLines, acquireLock, releaseLock, genericAppendFile, makeEEObservable, removeOneLine, removeMultipleLines, appendFile, acquireLockRetry, makeGenericObservable, ifFileExistAndIsAllWhiteSpaceThenTruncate, findFirstLine } = require('./helpers');
class Queue {
    constructor(obj) {
        this.eqStream = function (pauser, opts) {
        ...
        this.backpressure = function (val, fn) {
        ...
        this.enq = Queue.prototype.enqueue = function (lines, opts) {
            opts = opts || {};
            if (opts.controlled) {
        ...
        this.deq = Queue.prototype.dequeue = function (opts) {
            if (!opts || !opts.lines) {
                opts = Object.assign({
                    youngerThan: null,
                    olderThan: null,
