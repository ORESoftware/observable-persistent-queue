...
exports.findFirstLine = function _findFirstLine(queue, pattern){
    ...
    return sed(queue, pattern, count, choice)
        .map(data => {
            ...
            //
            // if (!l) {
            //     console.log('\n', colors.bgMagenta(' => [findFirstLine] Warning no line returned.'));
            //     return undefined;
            // }
            //
            // var parsed;
...
exports.removeOneLine = function _removeOneLine(queue, pattern) {
    ...
    return sed(queue, pattern, count, choice)
        .map(data => {
            ...
            if(data.length > 1){
                console.error(' => Warning => removeOneLine data had a length greater than 1.');
            }
            return data[0];
            ...
            //
            // if (!l) {
            //     console.log('\n', colors.bgMagenta(' => [removeOneLine] Warning no line returned.'));
            //     return undefined;
            // }
            //
            // var parsed;
            ...
            // catch (err) {
            //     console.error(colors.red(' => JSON.parse error =>'), '\n' + err.stack);
            //     console.error(' => Line could not be parsed => ' + util.inspect(l));
            //     return undefined;
            // }
            //
            // debug(' => Line that was parsed => ', parsed);
...
exports.removeMultipleLines = function _removeMultipleLines(queue, pattern, count) {
    ...
    return sed(queue, pattern, count, choice)
        .map(data => {
            ...
            //
            // if (lines.length < 1) {
            //     console.log('\n', colors.bgMagenta(' => [removeMultipleLines] Warning no line returned.'));
            // }
            //
            // return lines;
        });
