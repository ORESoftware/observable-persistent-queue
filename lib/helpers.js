...
exports.makeEEObservable = function _makeEEObservable(ee, isCallOnCompleted) {
...
const makeGenericObservable = exports.makeGenericObservable = function _makeGenericObservable(fn, isCallOnCompleted) {
    return Rx.Observable.create(obs => {
        if (!fn) {
