...
module.exports = Object.freeze({
    ...
    //string
    testDir: 'dist/test',
    testSrcDir: 'dist/test/test-src',                        // recommended that you create a test/test-src directory
    testTargetDir: 'dist/test/test-target',              // recommended to transpile to test/test-target directory
